        ...
        <div class="col-sm-offset-1 col-sm-10 pad-clr qili-about-us">
            ...
            @if(!empty($type))
                ...
                <div class="bgc-0 col-sm-10 pad-clr @if($type != 3)hidden @endif">
                    ...
                    <img class="img-responsive" src="{{asset('home/img/about-us.jpg')}}">
                    <p>
                        1.本站版权属于  武汉奇立英雄会网络科技有限公司所有，武汉奇立网络科技有限公司书面授权，任何企业、网站、个人不得转载、摘编、镜像或利用其它方式使用本站内容。经武汉奇立英雄会网络科技有限公司授权使用作品的，应在授权范围内使用，并注明“来源：www.jg110.com ” ，同时不得将稿件提供给任何第三方，违者本网将保留依法处理的权利。有关作品内容、版权、合作和其它问题，请发信至qlyingxionghui@163.com。
                    </p>
                </div>
            @else
