...
@section('content')
    ...
    <section class="container-fluid rodeing-type">
        <ul class="row">
            ...
            <li class='col-lg-1 col-md-1 col-sm-1 col-xs-2'><a class="@if($type == 1) active @endif" href="{{ route('action.index', ['type' => '1']) }}">创业大赛</a></li>
            <li class='col-lg-1 col-md-1 col-sm-1 col-xs-2'><a class="@if($type == 2) active @endif" href="{{ route('action.index', ['type' => '2']) }}">路演活动</a></li>
        </ul>
    </section>
