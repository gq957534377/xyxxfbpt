...
@section('script')
    ...
    <script>
        $(function(){
            ...
            $('#pro_details_readmore').click(function(){
                var pro_id = $(this).attr('pro_id');
                project.ajax('create','get',{},function(data){
                    if(data.status==200&data.data!=3) return alert('请先申请成为投资者');
                    project.ajax('/project_user/'+pro_id,'get',{},function(data){
                        if (data.status==200) project.creatDetail(data.data[0],$('#readmore'));
                    });
                });
            })
        })
