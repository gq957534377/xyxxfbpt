                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-2 text-center">
                                <div class="entry-meta">
                                    <span id="publish_date">{{date('Y-m-d H:i:s', $v->roaldShow_time)}}</span>
                            ...
                            <div class="col-xs-12 col-sm-10 blog-content">
                                ...
                                <h3>{{$v->brief}}</h3>
                                <a class="btn btn-primary readmore" href="/roald/{{$v->roaldShow_id}}">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>    
                    </div><!--/.blog-item-->
                     @endforeach
