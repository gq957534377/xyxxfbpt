...
@section('content')
      ...
      <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10 my-project-upload">
        ...
        <p class="text-center fs-12 fs-c-2 mar-3">再次审核通过后会显示在“创新作品”</p>
        ...
        <form id="projectForm" class="form-horizontal personal-data-edit" role="form" method="POST" action="#" accept-charset="UTF-8" enctype="multipart/form-data">
          ...
          <div class="form-group mar-b30">
            ...
            <div class="col-md-8 col-lg-8">
              <textarea name="brief_content" class="form-control text-r ht-8" id="form-introduction">{{$data->brief_content}}</textarea>
            </div>
          </div>
          <!--一句话介绍 结束-->
          <!--行业 开始-->
          ...
          <div class="form-group mar-b30">
            ...
            <div class="col-md-8 col-lg-8">
              <textarea name="content" class="form-control text-r ht-8" id="project-details">{{$data->content}}</textarea>
            </div>
          </div>
          <!--项目详情 结束-->
          <!--项目历程 开始-->
            ...
            <div class="col-md-5 col-lg-5">
              <div id="logo" class="col-md-6">
                <div class="avatar-view" title="">
                  <img class="lgt" src="{{ $data->logo_img }}" alt="Logo">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="form-group mar-b30">
            ...
            <div class="col-md-5 col-lg-5">
              <div id="banner" class="col-md-6">
                <div class="avatar-view" title="">
                  <img class="bner"  src="{{ $data->banner_img }}" alt="Logo">
                </div>
              </div>
            </div>
          </div>
