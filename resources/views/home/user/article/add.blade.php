...
@section('content')
    ...
    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10  mar-clr my-road row">
        ...
        <form action="{{ url('send') }}" id="add-form" class="add2-form" method="post">
            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="source" placeholder="请输入来源">
                        </div>
                    </div>
                </div>
            </div>
