...
@section('content')
      ...
      <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10 my-project-upload">
        ...
        <form id="projectForm" class="form-horizontal personal-data-edit" role="form" method="POST" action="#" accept-charset="UTF-8" enctype="multipart/form-data">
          ...
          <!--上传logo 开始 -->
          <div class="form-group mar-b30">
            <input class="hiddens" type="text" name="logo_img">
            <input class="hiddens" type="text" name="banner_img">
            <label for="upload-logo" class="col-md-3 col-lg-2 control-label pad-cr mar-xs--b"><span class="form-star">*</span>上传logo</label>
            <div class="col-md-5 col-lg-5">
              <input type="button" onclick="inputlogo.click()" id="upload-logo" class="upload-button zxz">
              <input type="file" id="inputlogo" class="hidden" >
            </div>
          </div>
          <!--上传 logo 结束-->
          <!--上传banner 开始-->
          <div class="form-group mar-b30">
            ...
            <div class="col-md-5 col-lg-5">
              <input type="button" onclick="inputbanner.click()" id="upload-banner" class="upload-button zxz">
              <input type="file" id="inputbanner" class="hidden" >
            </div>
          </div>
          <!--上传banner 结束-->
            ...
            <div class="col-md-9 col-lg-10">
              ...
              <div class="row mar-clr">
                ...
                <div class="col-xs-9 col-sm-5 col-md-5 col-lg-5 mar-3 pad-cl">
                  <input type="button" onclick="memberpic.click()" id="member-pic" class="upload-button-1 zxz">
                  <input type="file" id="memberpic" class="hidden" >
                </div>
              </div>
              <div class="row mar-clr">
