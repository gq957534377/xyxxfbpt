...
@section('content')
    ...
    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10  mar-clr my-road row">
        ...
        <form action="{{ url('userGoods') }}" id="add-form" class="add2-form" method="post">
            {{ csrf_field() }}
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <textarea id="UE" name="content"></textarea>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <input type="hidden" id="path" name="banner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="wechat" placeholder="请输入微信">
                        </div>
                    </div>
                </div>
            </div>
