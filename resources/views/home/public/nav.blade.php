    ...
    <div class="container pad-clr">
        ...
        <div class="collapse navbar-collapse pad-clr nav-opening" id="qili-navbar-collapse">
            <ul class="nav-content pad-cl">
                <li class="nav-status"><a href="{{ route('index') }}">奇力首页</a></li>
                <li class="hidden-xs"><div></div></li>
                <li class="nav-status"><a href="{{ route('project.index') }}">创新作品</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu qili-dropdown" role="menu">
                        <li class="nav-child-status"><a href="{{ route('school.index', ['type' => '1']) }}">企业管理</a></li>
                        <li class="nav-child-status"><a href="{{ route('school.index', ['type' => '2']) }}">资金管理</a></li>
                        <li class="nav-child-status"><a href="{{ route('school.index', ['type' => '3']) }}">人才管理</a></li>
                    </ul>
                </li>
                <li class="hidden-xs"></li>
                {{--<li class="nav-status"><a href="/article?type=1">市场资讯</a></li>--}}
                <li class="nav-status"><a href="{{ route('article.index', ['type' => '1']) }}">市场资讯</a></li>
                <li class="hidden-xs"></li>
                {{--<li class="nav-status"><a href="/article?type=2">创业政策</a></li>--}}
                <li class="nav-status"><a href="{{ route('article.index', ['type' => '2']) }}">创业政策</a></li>
                <li class="hidden-xs"></li>
                <li class="dropdown">
