                        ...
                        <div class="bg-picture" style="background-image:url('images/bg_6.jpg')">
                          ...
                          <div class="box-layout meta bottom">
                            <div class="col-sm-6 clearfix">
                              <span class="img-wrapper pull-left m-r-15"><img src="http://cdn.rooyun.com/picture/avatar-2.jpg" alt="" style="width:64px" class="br-radius"></span>
                            ...
                            <div class="col-sm-6">
                              ...
                              <div class="pull-right">
                                <div class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle btn btn-primary" href="#"> 操作 <span class="caret"></span></a>
                        ...
                        <div class="panel panel-default p-0">
                            <div class="panel-body p-0">
                                <ul class="nav nav-tabs profile-tabs">
                                    <li class="active"><a data-toggle="tab" href="#aboutme">简介</a></li>
                                    <li class=""><a data-toggle="tab" href="#user-activities">活动</a></li>
                                    <li class=""><a data-toggle="tab" href="#edit-profile">设置</a></li>
                                    <li class=""><a data-toggle="tab" href="#projects">项目</a></li>
                                </ul>
                                    ...
                                    <div class="user-profile-content">
                                        <form role="form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="张三" id="FullName" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" placeholder="6 - 15字符" id="Password" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="RePassword">确定密码：</label>
                                                <input type="password" placeholder="6 - 15字符" id="RePassword" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="AboutMe">简介：</label>
