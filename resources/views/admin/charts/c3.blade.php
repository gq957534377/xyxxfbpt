...
@section('script')
    <!--C3 Chart-->
    <script src="http://cdn.rooyun.com/js/d3.v3.min.js"></script>
    <script src="http://cdn.rooyun.com/js/c3.js"></script>
    <script src="http://cdn.rooyun.com/js/c3-chart.init.js"></script>
@endsection