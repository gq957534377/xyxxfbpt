...
<div class="wraper container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress-bar-purple" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width: 95%;">
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Striped example</h3>
                </div>
                <div class="panel-body">
                    <div class="progress">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress-bar-danger progress-bar-striped" role="progressbar" aria-valuenow="81" aria-valuemin="0" aria-valuemax="100" style="width: 81%;">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Sizes example</h3>
                </div>
                <div class="panel-body">
                    <div class="progress">
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Animated example</h3>
                </div>
                <div class="panel-body">
                    <div class="progress">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Completed example</h3>
                </div>
                <div class="panel-body">
                    <div class="progress progress-md">
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Stacked example</h3>
                </div>
                <div class="panel-body">
                    <div class="progress">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Animated Striped example</h3>
                </div>
                <div class="panel-body">
                    <div class="progress">
