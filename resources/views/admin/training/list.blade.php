...
@section('content')
    {{-- 弹出表单开始 --}}
    <button style="float: right;" class="btn btn-primary" data-toggle="modal" data-target="#con-close-modal">添加创业培训项目<i class="fa fa-plus"></i></button>
    <!--继承组件-->
    <!--替换按钮ID-->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group no-margin">
                ...
                <textarea class="form-control autogrow" placeholder="请详细描述创业项目培训内容" style="overflow: hidden; word-wrap: break-word; resize: horizontal; id="UE" name="describe"></textarea>
            </div>
        </div>
    </div>
@endsection
