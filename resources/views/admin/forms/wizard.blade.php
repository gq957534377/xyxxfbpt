...
<link rel="stylesheet" type="text/css" href="http://cdn.rooyun.com/css/jquery.steps.css" />
@section('content')
@section('title', '向导表单')
...
@section('script')
    <!--Form Wizard-->
    <script src="http://cdn.rooyun.com/js/jquery.steps.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="http://cdn.rooyun.com/js/jquery.validate.min.js"></script>

    <!--wizard initialization-->
    <script src="http://cdn.rooyun.com/js/wizard-init.js" type="text/javascript"></script>
@endsection