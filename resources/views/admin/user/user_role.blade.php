...
@section('content')
    ...
    <div class="btn-toolbar" role="toolbar">
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-default dropdown-toggle addevent" data-toggle="dropdown">待审核
...
@section('script')
    ...
    <script>
        ...
        //请求数据 与 分页
        $(function () {
//            var selector = '#normal, #aside_normal, #entrepreneurs, #aside_entrepreneurs' +
//                    '#investor, #aside_investor, #check_entrepreneurs, #aside_check_entrepreneurs' +
//                    '#check_investor, #aside_check_investor';
