                    ...
                    <div class=" form p-20">
                        ...
                        <form class="cmxform form-horizontal tasi-form" id="textfrom" method="get" action="#">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class="form-control " id="tel" type="text" name="tel" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class="form-control " id="time" type="text" name="time" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="curl" class="control-label col-lg-2">备案内容：</label>
                                <div class="col-lg-10">
                                    <input class="form-control " id="record" type="text" name="record">
                                </div>
                            </div>
