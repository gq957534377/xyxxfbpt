<div class="" id="crop-avatar">
    ...
    <!-- Current avatar -->
    <div class="avatar-view" title="增加合作机构" style="width: 100%;height: 100%;">
    ...
    <div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form class="avatar-form" action="{{ url('/web_cooper_organiz') }}" enctype="multipart/form-data" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" name="guid" value="http://img1.imgtn.bdimg.com/it/u=3387611966,1108989621&fm=21&gp=0.jpg">
                    <div class="modal-header">
                        <button class="close" data-dismiss="modal" type="button">&times;</button>
                        <h4 class="modal-title" id="avatar-modal-label">添加合作机构</h4>
                    </div>
                        ...
                        <div class="avatar-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" data-method="coopname" name="coopname" placeholder="name">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="coopurl" placeholder="url">
                                    </div>
                                </div>
                            </div>
                            <br>
