...
<script src="{{ asset('heroHome/js/bootstrap.min.js') }}"></script>
<link href="{{ asset('heroHome/css/bootstrap.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('heroHome/css/nav.css') }}" rel="stylesheet">
