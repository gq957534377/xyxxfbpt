...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $chooseBtn = $('' +
         ...
         '<button type="button" class="ssi-button success">' + this.language.chooseFiles + '</button>' +
         '</span>').append(element);
        var $uploadBtn = $('<button type="button" id="ssi-uploadBtn" class="ssi-button success ssi-hidden" >' +
...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        ...
        ch_voice: {
            ...
            clear: "清空",
            drag: "可拖拽存入语音文件",
            sizeError: "$1 超过最大文件限制 $2",
            extError: "$1 类型语音文件暂不支持",
            someErrorsOccurred: "出错了!"
        },
        gr: {
            success: 'Επιτυχία',
