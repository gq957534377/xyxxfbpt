...
function carouselHtml (data) {
    ...
    data.forEach(function (value) {
        ...
        html += '<a href="" data-id="'+ value.id +'" class="btn btn-success tooltips" data-placement="top" data-toggle="modal" data-target="#custom-width-modal" data-original-title="Edit">';
