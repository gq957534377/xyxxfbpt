!function (a) {
    ...
    var z = function () {
        ...
        var p = function (b) {
            var c = a(b).closest(".note-editor, .note-air-editor, .note-air-layouts");
        ...
        this.createLayoutByAirMode = function (b, c) {
            ...
            l.addClass("note-air-layouts"), l.attr("id", "note-popover-" + h), l.appendTo(j), x(l, g), y(l, c);
            var m = a(k());
            m.addClass("note-air-layouts"), m.attr("id", "note-handle-" + h), m.appendTo(j);
            var n = a(u(d, c));
            n.addClass("note-air-layouts"), n.attr("id", "note-dialog-" + h), n.find("button.close, a.modal-close").click(function () {
